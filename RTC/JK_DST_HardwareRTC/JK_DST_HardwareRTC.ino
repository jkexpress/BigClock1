...
//
//
// notes from gov.au Daylight Saving Time begins at 2am on the first Sunday in October, 
//when clocks are put forward one hour. It ends at 2am (which is 3am Daylight Saving Time)
//on the first Sunday in April, when clocks are put back one hour.

TimeChangeRule myDST = {"AEDT", First, Sun, Oct, 2, +660};    //Daylight time = UTC + 11 hours
TimeChangeRule mySTD = {"AEST", First, Sun, Apr, 2, +600};     //Standard time = UTC + 10 hours
